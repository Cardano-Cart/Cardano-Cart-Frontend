        ...
        <CardContent sx={{ py: 3 }}>
          <Grid container>
            <Grid
              ...
              sm={6}
              md={2.4}
              sx={{ display: "flex", alignItems: "center", position: "relative", px: 2 }}
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                <HeadphonesOutlinedIcon sx={{ color: "#3f51b5", fontSize: 32 }} />
                <Box>
              ...
              <Divider
                ...
                flexItem
                sx={{ position: "absolute", right: 0, display: { xs: "none", md: "block" } }}
              />
            </Grid>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                <Typography sx={{ color: "#3f51b5", fontSize: 32 }}>₳</Typography>
                <Box>
                  <Typography variant="subtitle2" fontWeight="bold" color="text.primary">
                    ACCEPT PAYMENT
                  </Typography>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                <LockOutlinedIcon sx={{ color: "#3f51b5", fontSize: 32 }} />
                <Box>
                  <Typography variant="subtitle2" fontWeight="bold" color="text.primary">
                    SECURED PAYMENT
                  </Typography>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                <LocalShippingOutlinedIcon sx={{ color: "#3f51b5", fontSize: 32 }} />
                <Box>
                  <Typography variant="subtitle2" fontWeight="bold" color="text.primary">
                    FREE SHIPPING
                  </Typography>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                <CalendarTodayOutlinedIcon sx={{ color: "#3f51b5", fontSize: 32 }} />
                <Box>
                  <Typography variant="subtitle2" fontWeight="bold" color="text.primary">
                    30 DAYS RETURN
                  </Typography>
      ...
      <Box sx={{ my: 6 }}>
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" color="text.secondary">
              Last Month up to 1500+ Products Sales From this category. You can choose a product from here and save
              money.
            </Typography>
          </Grid>
                ...
                <ProductCard onClick={() => (window.location.href = `/product/${product.id}`)}>
                  ...
                  <ProductImageContainer>
                    <Box sx={{ p: 3, display: "flex", justifyContent: "center" }}>
                      <Image
                        src={product.images[0]?.image_url || "/images/watch.jpg"}
                        alt={product.name}
                        width={150}
